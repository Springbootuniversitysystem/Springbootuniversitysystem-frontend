        ...
        <nav className="career-nav">
          ...
          <div className="nav-actions">
            {isLoggedIn ? (
                <>
                  {isAdmin && (
                      <Link to="/admin" className="nav-login-link" style={{ color: '#d4af37', marginRight: '15px' }}>
                        Admin Portal
                      </Link>
                  )}
                  <Link to="/profile" className="nav-signup-btn" style={{ marginRight: '10px' }}>
                    My Profile
                  </Link>
                  <button onClick={handleLogout} className="nav-login-link" style={{ background: 'transparent', border: '1px solid currentColor', cursor: 'pointer', padding: '8px 16px', borderRadius: '4px' }}>
                    Logout
                  </button>
                </>
            ) : (
                <>
                  <Link to="/sign-in" className="nav-login-link">
                    <img src="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/icons/box-arrow-in-right.svg" alt="" className="nav-icon-dark" />
                    Login
                  </Link>
